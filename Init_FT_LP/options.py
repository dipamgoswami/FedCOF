...
def args_parser():
    ...
    parser.add_argument('--model', type=str, default=None, help='set model, resnet, mobilenet or squeezenet')
    ...
    parser.add_argument('--fedcof', type=int, default=None, help='use fedcof if 1')
    parser.add_argument('--fed3r', type=int, default=None, help='use fed3r if 1')
    parser.add_argument('--shrink', type=float, default=1.0, help='value of covariance shrinkage')
    parser.add_argument('--need_cov', type=int, default=0, help='share covariances from clients if 1')
    ...
    parser.add_argument('--subsets', type=int, default=1, help='number of subsets in each client')                                                                        
